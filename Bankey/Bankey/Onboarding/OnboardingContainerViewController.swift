...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean",
                                             titleText: "Bankey is faster, easier to use, and has a brand new look and feel that make you feel like you are back in the 80s.")
    ...
    override func viewDidLoad() {
        ...
        // Add child view controllers to a parent view controller
